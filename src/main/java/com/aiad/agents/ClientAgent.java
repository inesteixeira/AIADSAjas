...
public class ClientAgent extends Agent {
    ...
    public ClientAgent(String name, String typeOfInsurance, String first, String second, String third, String isNegotiatior, String max, String min) {
        this.name = name;
        this.typeOfInsurance = typeOfInsurance;
        this.firstCondition = first;
        this.secondCondition = second;
        this.thirdCondition = third;
        this.isNegotiator = Boolean.parseBoolean(isNegotiatior);
        this.maxDiscount = Integer.parseInt(max);
        this.minDiscount = Integer.parseInt(min);
    }
    ...
    protected void setup() {
        ...
        if (args != null && args.length > 0) {
            ...
            try {
                ...
                agency = new sajas.core.AID[result.length];
                ...
                case 1:
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.PROPOSE) {
                            ...
                            System.out.println("All Brokers refused, since no brokers sell " + typeOfInsurance + " insurances.");
                            takeDown();
                        }
        ...
        public void action() {
            ...
            switch (step){
                ...
                case 0:
                    ...
                    break;
                case 1:
                    //MessageTemplate messageTemplate2 = MessageTemplate.MatchConversationId("fromBroker2");
    ...
    public void doDelete() {
        System.out.println("Client-agent " + getAID().getName() + " do Delete.");
        super.doDelete();
    }*/
